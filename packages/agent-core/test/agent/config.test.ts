...
describe('Agent config', () => {
  ...
  it('keeps turn-start config for later steps and applies updates to the next turn', async () => {
    ...
    expect(formatHarnessSnapshot(await ctx.untilTurnEnd())).toMatchInlineSnapshot(`
      ...
      [wire] context.cache_churn         { "blockName": "tools", "cacheScope": "global", "beforeHash": "5e446f0ad00689ccfab3057e46c32d64fd650fbc95eeaf25386bfe25a4dfbe6c", "afterHash": "4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945", "time": "<time>" }
