...
- **Implemented by**: #210（Spike — GO，见 `docs/research/spike-0020-compile-native-smoke.md`）；#219（compile 管线 + release.yml 过 R15）；#221（engines Bun-only + 删 SEA/pnpm 钉死 + flake experimental）
- **Debugged by**:
- **Arch reviewed by**:
- **Reviewed by**:
