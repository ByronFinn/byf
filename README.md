...
| **Contributors / CI**                                                | **Bun >= 1.3.14** only (`bun install`, `make test` / `bun run test`, …). Full suite is process-isolated — not bare root `bun test`. pnpm is not the official toolchain. |
